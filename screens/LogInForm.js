...
export default class LoginInForm extends React.Component {
            ...
            <LinearGradient style={customStyles.mainContainer}
                ...
                <View style={customStyles.container}>
                    <View style={customStyles.firstRow}>
                        ...
                        <Text h5 style={customStyles.textColor} onPress={() => navigate('LogInFormStack')}>Forgot Password?</Text>
                    </View>
                    <View>
                        <Text h3 style={customStyles.textColor}>Log In</Text>
                    </View>
